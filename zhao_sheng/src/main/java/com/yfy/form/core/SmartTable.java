...
import com.yfy.form.component.IComponent;
import com.yfy.form.component.ITableTitle;
import com.yfy.form.component.TableProvider;
import com.yfy.form.component.TableTitle;
import com.yfy.form.component.XSequence;
import com.yfy.form.component.YSequence;
import com.yfy.form.data.TableInfo;
import com.yfy.form.data.column.Column;
import com.yfy.form.data.format.selected.ISelectFormat;
import com.yfy.form.data.style.FontStyle;
import com.yfy.form.data.table.PageTableData;
import com.yfy.form.data.table.TableData;
import com.yfy.form.listener.OnColumnClickListener;
import com.yfy.form.listener.OnTableChangeListener;
import com.yfy.form.matrix.MatrixHelper;
    ...
    private void requestReMeasure() {
        ...
        if (!isExactly && getMeasuredHeight() != 0 && tableData != null) {
            if (tableData.getTableInfo().getTableRect() != null) {
                int defaultHeight = tableData.getTableInfo().getTableRect().height() + getPaddingTop();
