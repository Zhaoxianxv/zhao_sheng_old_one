...
import com.yfy.app.appointment.OrderLogisticsShowActivity;
...
//        getRandomHeights(dataList);
    ...
    public OrderMainAdapter(Activity mContext, List<OrderBean> dataList) {
        ...
        RecyclerViewHolder(View itemView) {
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(mContext, OrderLogisticsShowActivity.class);
                    Bundle b=new Bundle();
