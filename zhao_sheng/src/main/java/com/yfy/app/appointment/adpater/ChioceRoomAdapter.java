...
public class ChioceRoomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Rooms> dataList;
    private Activity mContext;

    public void setDataList(List<Rooms> dataList) {
...
//        getRandomHeights(dataList);
    ...
    public ChioceRoomAdapter(Activity mContext){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof RecyclerViewHolder) {
            ...
            reHolder.name.setText(reHolder.bean.getRoom_name());
        }
    }
