...
import com.yfy.app.property.PropertyTermActivity;
 ...
 * @Desprition
 */
public class PropertyMainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


	private List<PropretyRoom> rooms;
	private PropertyMainActivity activity;
	...
	public PropertyMainAdapter(PropertyMainActivity activity, List<PropretyRoom> rooms) {
		this.rooms=rooms;
	...
	public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		if (viewType == TYPE_ITEM) {
			View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.property_room_item, parent, false);
		...
		RecyclerViewHolder(View itemView) {
			...
			name.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent=new Intent(activity, PropertyTermActivity.class);

					activity.startActivityForResult(intent, TagFinal.UI_REFRESH);
				}
			});
