...
import com.yfy.form.annotation.ColumnType;
import com.yfy.form.annotation.SmartColumn;
import com.yfy.form.data.column.ArrayColumn;
import com.yfy.form.data.column.Column;
import com.yfy.form.data.table.PageTableData;
import com.yfy.form.exception.TableException;
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(com.yfy.form.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    com.yfy.form.annotation.SmartTable table = (com.yfy.form.annotation.SmartTable) tableAnnotation;
