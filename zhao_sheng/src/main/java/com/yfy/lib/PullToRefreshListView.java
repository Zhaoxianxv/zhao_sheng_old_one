	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		if (mListViewExtrasEnabled) {
			...
			LoadingLayout footer = defineFooterLayout(getContext(),
					PullToRefreshBase.Mode.PULL_FROM_END, a);

			// Create Loading Views ready for use later
			FrameLayout frame = new FrameLayout(getContext());
			mHeaderLoadingView = header == null ? createLoadingLayout(
					getContext(), PullToRefreshBase.Mode.PULL_FROM_START, a) : header;
			...
			mFooterLoadingView = footer == null ? createLoadingLayout(
					getContext(), PullToRefreshBase.Mode.PULL_FROM_END, a) : footer;
			mFooterLoadingView.setVisibility(View.GONE);
