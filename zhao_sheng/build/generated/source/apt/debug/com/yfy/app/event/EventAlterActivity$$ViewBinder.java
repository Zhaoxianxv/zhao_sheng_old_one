...
public class EventAlterActivity$$ViewBinder<T extends com.yfy.app.event.EventAlterActivity> extends com.yfy.base.activity.BaseActivity$$ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296731, "field 'del_mult'");
    target.del_mult = finder.castView(view, 2131296731, "field 'del_mult'");
    view = finder.findRequiredView(source, 2131296732, "field 'layout'");
    target.layout = finder.castView(view, 2131296732, "field 'layout'");
    view = finder.findRequiredView(source, 2131296730, "method 'setDelEvent'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
