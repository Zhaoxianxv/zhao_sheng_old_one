package com.yfy.form.data.column;

import android.graphics.Paint;

import com.yfy.form.data.TableInfo;
import com.yfy.form.data.format.IFormat;
import com.yfy.form.data.format.count.DecimalCountFormat;
import com.yfy.form.data.format.count.ICountFormat;
import com.yfy.form.data.format.count.NumberCountFormat;
import com.yfy.form.data.format.count.StringCountFormat;
import com.yfy.form.data.format.draw.FastTextDrawFormat;
import com.yfy.form.data.format.draw.IDrawFormat;
import com.yfy.form.data.format.draw.MultiLineDrawFormat;
...
public class Column<T> implements Comparable<Column> {
    ...
    public void addData(List<Object> objects, int startPosition, boolean isFoot)
